  ...
  render(){
    return(
      <div className="main">
        <Landing />
        <div className="deck">
          <Card image={ this.props.jhsucomponents } page="jhsucomponents" title="JHsu Components" description="A library of Styled Components in React, available on npm." tags="React | Styled Components | Storybook | Jest | NPM" />
          ...
          <Card image={ this.props.wip } page="keeper" title="Keeper - Work in Progress" description="My personal management web app." tags="React | TailwindCSS | Back End TBD" />
        </div>
      </div>
    );
  }

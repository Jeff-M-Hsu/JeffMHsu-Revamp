    ...
    return(
      <div className="topbar">
        ...
        <div id="social-media">
          ...
          <a className="icon-link" rel="noopener noreferrer" href="https://www.linkedin.com/in/jeffreyhsu42" target="_blank"><img className="icon" alt="Linkedin logo" src={ Linkedin }></img></a>
